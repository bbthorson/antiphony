...
const surface = {
    $comment:
        'Generated by `npm run gen:openapi`. The public API surface (path+method set), guarded by openapi-surface.test.ts. Do not edit by hand — regenerate and commit alongside any surface change in the same PR. See specs/core-surface.md.',
